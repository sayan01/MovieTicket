...
public class PrintTicket
	...
	// the class needs to implement Printable interface in order to be passed as a Printable
// to the PrinterJob class's setPrintable() method
	/*
	 *	Method: print()
	 *	Parameters: Graphics g - The Graphics object to draw on
	 *   PageFormat pf - The PageFormat object containing information about the page
	 *	 int page - page number
	 *	Returns:  int - returns if PAGE EXISTS or not
	 *	Desc:	
	 *	This method is a method needed to be overloaded
	 *	on implementing the Printable interface,
	 *	It is called when the PrinterJob.print() method is called
	 *	Here details of what to print in the receipt is decided
	 *	by drawing on the passed Graphics object
	 */
	public int print(Graphics g, PageFormat pf, int page) {
		...
		for(int i = 0; i<labels.length;i++) {
			...
			y = printExcess(g,data,y,40);// draw field data 
			//if data is too big, continue drawing in
			// next lines (wordWrap)
